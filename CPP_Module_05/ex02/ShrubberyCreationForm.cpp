...
ShrubberyCreationForm::ShrubberyCreationForm(void):
	AForm("default_presidential_form", ShrubberyCreationForm::formSignGrade, ShrubberyCreationForm::formExecGrade), target("default_target") {}

ShrubberyCreationForm::~ShrubberyCreationForm(void) {}

ShrubberyCreationForm::ShrubberyCreationForm(const std::string& target):
	AForm("default_presidential_form", ShrubberyCreationForm::formSignGrade, ShrubberyCreationForm::formExecGrade), target(target) {
}
